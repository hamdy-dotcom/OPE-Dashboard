 ...
 *
 * State is plain `useState`, not URL-driven — unlike the record drawer this
 * carries no data, so there's nothing that needs to survive a server render.
 */
  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="grid h-11 w-11 shrink-0 touch-manipulation place-items-center rounded-[8px] border border-hairline text-ink-2 transition-colors hover:bg-raise hover:text-ink xl:hidden"
      >
          ...
          >
            <div className="flex shrink-0 justify-end border-b border-hairline px-3 py-2.5">
              <button
                ...
                className="grid h-11 w-11 touch-manipulation place-items-center rounded-[8px] border border-hairline text-[15px] text-ink-2 transition-colors hover:bg-raise hover:text-ink"
              >
                ×
              </button>
            </div>
