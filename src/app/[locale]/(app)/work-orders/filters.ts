...
export function buildWorkOrderFilters(
  ...
  return [
    { key: "number", label: labels.number, kind: "text", inSearch: true, get: (r) => r.workOrderNumber },
    { key: "rfr", label: labels.rfr, kind: "text", inSearch: true, get: (r) => r.rfrNumber },
    { key: "vehicle", label: labels.vehicle, kind: "text", inSearch: true, get: (r) => [r.vehicleCode, r.plateNumber] },
    ...
    { key: "engineer", label: labels.engineer, kind: "picker", inSearch: true,
