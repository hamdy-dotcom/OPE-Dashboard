...
export function buildRfrFilters(
  ...
  return [
    { key: "number", label: labels.number, kind: "text", inSearch: true, get: (r) => r.rfrNumber },
    ...
    { key: "location", label: labels.location, kind: "text", inSearch: true, get: (r) => r.vehicleLocation },
